...
#include "utilidades/RuntimeLogger.h"
 ...
 * 
 * Utiliza pthread_sigmask() para bloquear SIGINT y SIGTERM en el hilo.
 * Esto asegura que solo el hilo que instala el manejador de señales
 * pueda recibirlas. Los demás hilos terminarán controladamente cuando
 * la variable running sea puesta a false.
 */
 ...
 * 
 * Útil para HiloIntArranque que necesita recibir las señales.
 */
...
private:
    ...
    pthread_t thread_;
    double frequency_;
    std::string name_;  // Nombre del hilo para identificación
